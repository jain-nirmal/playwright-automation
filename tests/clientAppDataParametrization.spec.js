...
const dataSetParameter = JSON.parse(JSON.stringify(require('../utils/DataParameterTestData.json')));


for (const dataSet of dataSetParameter)
    {

test(`@Webst Client App login for ${dataSet.productName}`, async ({ page }) => {
